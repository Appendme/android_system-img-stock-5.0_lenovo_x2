...
CUSTOM_HAL_IMGSENSOR = imx214_mipi_raw ov5693_mipi_raw
...
#lenovo-sw louhs1,remove,2015-02-02,begin
...
#lenovo-sw louhs1,remove,2015-02-02,end
...
CUSTOM_KERNEL_IMGSENSOR = imx214_mipi_raw ov5693_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = nt35595_fhd_dsi_vdo_lg otm1902a_fhd_dsi_cmd_tianma
...
# lenovo-sw fuxm1 modify 2015-04-01 for use nxp smartpa begain 
#CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SOUND = 
# lenovo-sw fuxm1 modify 2015-04-01 for use nxp smartpa end 

#lenovo-sw louhs1,remove,2015-02-02,begin
#CUSTOM_KERNEL_SSW = combo_fxla2203_v2
CUSTOM_KERNEL_SSW = combo_fxla2203_v3
#lenovo-sw louhs1,remove,2015-02-02,end
...
#lenovo-sw louhs1,modify,begin
#CUSTOM_KERNEL_TOUCHPANEL = GT9XX
CUSTOM_KERNEL_TOUCHPANEL = S3528
#lenovo-sw louhs1,modify,end

CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_LK_LCM = nt35595_fhd_dsi_cmd_truly_tps65132
#Lenovo-sw lixp5 2015-02-13 begin
CUSTOM_MODEM = mt6595k95_hspa_lwg_x2eu
#Lenovo-sw lixp5 2015-02-13 end
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = nt35595_fhd_dsi_cmd_truly_tps65132
...
#lenovo-sw louhs1, 20150205, remove,begin
#MTK_ANT_SUPPORT = yes
MTK_ANT_SUPPORT = no
#lenovo-sw louhs1, 20150205, remove,end
...
#lenovo-sw heww3 close mtk audio profile end
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L0.MP5.V1_LENOVO6595.LWT.L_P23
MTK_BWC_SUPPORT = yes
...
#lenovo-sw,louhs1,20150416,begin
#MTK_CLEARMOTION_SUPPORT = no
MTK_CLEARMOTION_SUPPORT = yes
#lenovo-sw,louhs1,20150416,end
MTK_CMAS_SUPPORT = no
...
#Lenovo-sw lixp5 2015-03-13 begin
MTK_DISABLE_CAPABILITY_SWITCH = no
MTK_DISABLE_SW_SIM_SWITCH = yes
#Lenovo-sw lixp5 2015-03-13 end
...
#/*lenovo-sw fuxm1 open for x2 support dual mic 2015-04-01*/
...
#lenovo-sw louhs1,remove,20150205, begin
#MTK_HDMI_SUPPORT = yes
MTK_HDMI_SUPPORT = no
#lenovo-sw louhs1,remove,20150205, end
...
#lenovo-sw louhs1,remove,begin
#MTK_HOTKNOT_SUPPORT = yes
MTK_HOTKNOT_SUPPORT = no
#lenovo-sw louhs1,remove,end
...
#/*lenovo-sw fuxm1 open for x2 support dual mic 2015-04-01 begain*/
MTK_INCALL_HANDSFREE_DMNR = yes
MTK_INCALL_NORMAL_DMNR = yes
#/*lenovo-sw fuxm1 open for x2 support dual mic 2015-04-01 end*/
...
#/*lenovo-sw fuxm1 open for x2 support sim card2 handfree 2015-04-09 begain*/
MTK_INT_MD_SPE_FOR_EXT_MD = no
#/*lenovo-sw fuxm1 open for x2 support sim card2 handfree 2015-04-09 end*/
...
MTK_MAV_SUPPORT = no
#Lenovo-sw lixp5 2015-02-13 begin
MTK_MD1_SUPPORT = 5 #6 #5-FDD;6-TDD
#MTK_MD1_SUPPORT = 5
MTK_MD2_SUPPORT = 4
MTK_MD5_SUPPORT = 0
#Lenovo-sw lixp5 2015-02-13 end
...
#lenovo-sw louhs1,20150205,begin
...
#Lenovo-sw quebs2 modified 20150415 begin,close controller with MTK permission
#MTK_PERMISSION_CONTROL = yes
MTK_PERMISSION_CONTROL = yes
#Lenovo-sw quebs2 modified end
...
MTK_PRODUCT_LOCALES = en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB bn_BD ka_GE fa_IR hi_IN
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_platform_mt6595 
...
MTK_SMT_SUPPORT = no
# lenovo-sw fuxm1 2015-03-26 modify for x2 use NXP smartpa begain
MTK_SPEAKER_MONITOR_SUPPORT = no
# lenovo-sw fuxm1 2015-03-26 modify for x2 use NXP smartpa end
...
#Lenovo-sw guhong 2015-03-13 begin
#MTK_UMTS_TDD128_MODE = no
MTK_UMTS_TDD128_MODE = no
#Lenovo-sw guhong 2015-03-13 end
...
MTK_PERF_POWER_SAVE = yes

MTK_CHARM_SUPPORT = no
MTK_HEART_RATE_MONITOR_SUPPORT = no
MTK_NFC_GSMA_SUPPORT = no

#lenovo wangyq13 add for cywee sensorhub 20150206 begin
MTK_SENSOR_SUPPORT_CYWEE = yes
#lenovo wangyq13 add for cywee sensorhub 20150206 end

###Lenovo-sw chailu1 modify 2015-2-6 begin
LENOVO_POWEROFF_CHARGING_UI = yes
LENOVO_PO_CHARGING_SUPPORT = yes
LENOVO_SHOW_UI_IN_BAT_OVERDISCHARGE = yes
LENOVO_SERIAL_FROM_BARCODE = yes

# lenovo-sw fuxm1 2015-02-12 add for smartpa tfa9890 support begain 
NXP_SMARTPA_SUPPORT = tfa9890
# lenovo-sw fuxm1 2015-02-12 add for smartpa tfa9890 support end 

# lenovo-sw fuxm1 2015-03-16 add for reovery & OTA & fuse related begain
#LENOVO_SHARED_SDCARD = yes
LENOVO_RECOVERY_SUPPORT = yes
# lenovo-sw fuxm1 2015-03-16 add for reovery & OTA & fuse related end

# lenovo-sw fuxm1 2015-05-05 add for adjust system volue for system sound begain
LENOVO_X2_L_SYSTEMVOL_SUPPORT = yes
# lenovo-sw fuxm1 2015-05-05 add for adjust system volue for system sound end
BUILD_GMS = yes
