...
/lib/libdpframework.so /lib/libion.so /lib/libged.so /lib/libpq_prot.so /lib/libpq_cust.so \
/lib/libstlport.so \
...
AUDIO="/lib/hw/audio.primary.mt6595.so /lib/libspeech_enh_lib.so /lib/libaudiocustparam.so /lib/libaudiosetting.so \
